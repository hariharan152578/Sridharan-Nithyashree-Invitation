...
export default function CalendarAndMapActions() {
  ...
  const handleDownloadIcs = () => {
    const icsContent = [
      ...
      "SUMMARY:Wedding Ceremony: Nithyashree & Sridharan",
      "DESCRIPTION:Vivaha Subhamuhurtha Mahotsavam of Selvi J. Nithyashree & Sri N. Sridharan at Sengunthar Kalyana Mandapam, Tiruchengode.",
      "LOCATION:Sengunthar Kalyana Mandapam, Tiruchengode",
      "STATUS:CONFIRMED",
      "END:VEVENT",
      "END:VCALENDAR",
    ].join("\r\n");
  ...
  const googleCalendarUrl = `https://calendar.google.com/calendar/render?action=TEMPLATE&text=${encodeURIComponent(
    "Wedding: Nithyashree & Sridharan"
  )}&dates=20261101T020000Z/20261101T033000Z&details=${encodeURIComponent(
    "Panigrahana Vivaha Subha Mahotsavam of Selvi J. Nithyashree & Sri N. Sridharan"
  )}&location=${encodeURIComponent("Sengunthar Kalyana Mandapam, Tiruchengode")}`;

  // Share link
  const handleShare = async () => {
    const shareData = {
      title: "Wedding Invitation - Nithyashree & Sridharan",
      text: "You are cordially invited to the wedding ceremony of Selvi J. Nithyashree & Sri N. Sridharan on Sunday, 01 November 2026 at Sengunthar Kalyana Mandapam, Tiruchengode.",
  ...
  return (
    <div className="flex flex-col gap-3 my-6 w-full max-w-sm mx-auto">
      {/* Google Maps Button */}
      <a
        href="https://www.google.com/maps/search/?api=1&query=Sengunthar+Kalyana+Mandapam+Tiruchengode"
        target="_blank"
