...
- **Scroll-Controlled Background Video**: Seamless background video playback dynamically synchronized with scroll activity.
- **Auspicious Muhurtham Timings**: Live countdown timer, Parabhava Year & Aippasi 15th alignments, Vrischika Lagna, and Punarvasu Nakshatra.
...
- **Typography**: Google Fonts (Cinzel, Great Vibes, Mea Culpa, Playfair Display, Outfit)
- **Icons**: Lucide React
...
Open [http://localhost:3000](http://localhost:3000) to view the invitation in your browser.
